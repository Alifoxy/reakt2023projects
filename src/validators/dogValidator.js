...
export const dogValidator = Joi.object({
    ...
    dog_breed:Joi.string().equal('golden retriever','german shepherd','doberman pinscher','poodle','bulldog','beagle','rottweiler','yorkshire terrier','siberian husky','chihuahua','no breed','other').required().messages({
