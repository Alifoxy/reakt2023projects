...
export const catValidator = Joi.object({
    ...
    cat_breed:Joi.string().equal('siamese','ragdoll','maine coon','persian','british','bengal','russian blue','scottish fold','tonkinese','siberian','no breed','other').required().messages({
